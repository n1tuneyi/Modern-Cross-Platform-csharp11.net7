...
try
{
    ...
    TarFile.CreateFromDirectory(sourceDirectoryName: sourceDirectory,
                                destinationFileName: tarFile, includeBaseDirectory: true);
    ...
    TarFile.ExtractToDirectory(sourceFileName: tarFile,
